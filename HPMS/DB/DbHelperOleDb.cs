...
namespace HPMS.DB
{
    ...
    public class SqlServer
    {
        ...
        {
            bool ret = false;
            string updateSql = "INSERT INTO HPMS (PN, TestItem) VALUES (?, ?)";
            OleDbParameter[] b = new OleDbParameter[2];
            bool convertFlag = false;
            byte[] content = File2ByteArray("config\\hardware.xml", out convertFlag);
            b[0] = new OleDbParameter("0", "555");
            b[1] = new OleDbParameter("1", content);
        ...
        public static void getSavedNumber()
        {
            string querySql = "SELECT * from HPMS where id=2";
            OleDbParameter[] b = new OleDbParameter[3];
           
            DataTable dt = DbHelperOleDb.Query(querySql, DB_MesDataCenterConnectionString).Tables[0];
            byte[] aa = (byte[])dt.Rows[0][2];
            ByteArray2File(aa, "B:\\sss.xml");
        }
