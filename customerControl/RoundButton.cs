...
namespace CustomerControl
{
     public partial class RoundButton : Button
    {
        ...
        private void DrawBack(Graphics g)
        {
                ...
                {
                    //this.Value = false;
                    Brush brush = new LinearGradientBrush(rect, Color.FromArgb(15, 87, 35), Color.FromArgb(15, 87, 15), LinearGradientMode.ForwardDiagonal);
                    g.FillEllipse(brush, rect);
                }
                else
                {
                   // this.Value = true;
                    Brush brush = new LinearGradientBrush(rect, Color.FromArgb(20, 254, 40), Color.FromArgb(20, 254, 20), LinearGradientMode.ForwardDiagonal);
                    g.FillEllipse(brush, rect);
                }
        ...
        protected virtual void PaintShape(Graphics g, Brush brush, RectangleF rect)
        {
           ...
           brush = new LinearGradientBrush(rect, Color.White, Color.Blue,LinearGradientMode.ForwardDiagonal);
            g.FillEllipse(brush, rect);
           // g.FillEllipse();
        }
